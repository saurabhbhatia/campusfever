...
require 'papers_controller'

# Re-raise errors caught by the controller.
class PapersController; def rescue_action(e) raise e end; end

class PapersControllerTest < Test::Unit::TestCase
  fixtures :papers

  def setup
    @controller = PapersController.new
